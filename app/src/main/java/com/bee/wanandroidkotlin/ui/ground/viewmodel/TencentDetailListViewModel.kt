 ...
 * @Description:
 */
class TencentDetailListViewModel(application: Application) : BaseRefreshAndListViewModel<ArticleListResponseData>(application) {
    ...
    override suspend fun getDataFromRepository(preResultList: ArrayList<ArticleListResponseData>): Boolean {
        ...
        val tencentTabListCall =
                httpModel.getTencentDetailList(currentPage, tagResponseBean!!.id)
